...
type User struct{
	...
	FirstName string `json:"first_name" xorm:"first_name" schema:"first_name" validate:"required,gte=3"`
	...
	Password string `json:"-" xrom:"password" schema:"password" validate:"required,gte=8"`
	Visible bool `json:"visible" xorm:"visible" schema:"visible"`
}

// TableName - table name in xorm when using xorm
...
// SetPassword - use bcrypt to set password hash
...
// Authenticate - authenticates password against stored hash
